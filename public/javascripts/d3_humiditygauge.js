const humidityGauge = function(configuration) {
  let that = {}
  ...
  function render(value) {
    ...
    // Place svg element
    svg = d3.select("#humiditygauge").append("svg")
...
const humiditygauge = new humidityGauge({
});
humiditygauge.update(Math.round(current_data.humidity))
